package org.example.meteorites.microscope.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.example.meteorites.microscope.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.example.meteorites.microscope.repository.UserRepository.USERS_BY_EMAIL_CACHE);
