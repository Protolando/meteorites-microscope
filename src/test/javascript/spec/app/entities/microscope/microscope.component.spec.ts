...
import { MicroscopeComponent } from 'app/entities/microscope/microscope.component';
...
describe('Component Tests', () => {
  describe('Microscope Management Component', () => {
    let comp: MicroscopeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MicroscopeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.microscopes && comp.microscopes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
