...
import { RockComponent } from 'app/entities/rock/rock.component';
import { RockService } from 'app/entities/rock/rock.service';
import { Rock } from 'app/shared/model/rock.model';

describe('Component Tests', () => {
  describe('Rock Management Component', () => {
    let comp: RockComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RockComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.rocks && comp.rocks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
